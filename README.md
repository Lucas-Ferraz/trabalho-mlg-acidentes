...
O objetivo principal do estudo é investigar os fatores climáticos, viários e operacionais associados à ocorrência de óbitos em acidentes registrados nas rodovias federais brasileiras, aplicando **Modelos Lineares Generalizados (Regressão Logística)** aos dados abertos da Polícia Rodoviária Federal (PRF).
